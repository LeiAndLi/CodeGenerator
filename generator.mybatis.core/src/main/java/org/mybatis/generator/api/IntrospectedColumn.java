...
public class IntrospectedColumn {
    ...
    public String getJavaPropertySubfix(String subfix) {
    	if (subfix == null) {
    		return javaProperty;
    	}
    ...
    public FullyQualifiedJavaType getFullyQualifiedJavaType() {
    	SecurityColumn sc = this.introspectedTable.getTableConfiguration().getSecurityColumn(this.actualColumnName);
    	if(sc != null){
    		System.out.println(this.actualColumnName);
    		System.out.println(sc.getColumnName());
    		System.out.println(sc.getJavaType());
    		System.out.println(sc.getJdbcType());
    		Assert.notNull(sc.getJavaType());
    		return new FullyQualifiedJavaType(sc.getJavaType());
    	}else{
    ...
    public boolean isSecurity(){
    	return this.introspectedTable.getTableConfiguration().getSecurityColumn(this.actualColumnName) != null;
    }
    
    
    public String getSecurityJavaType(){
    	SecurityColumn sc = this.introspectedTable.getTableConfiguration().getSecurityColumn(this.actualColumnName);
    	if(sc != null){
    		return sc.getJavaType();
    	}
    	
    	return this.getJavaProperty();
    }
    
    public String getSecurityJdbcType(){
    	SecurityColumn sc = this.introspectedTable.getTableConfiguration().getSecurityColumn(this.actualColumnName);
    	if(sc != null){
    		return sc.getJdbcType();
    	}
