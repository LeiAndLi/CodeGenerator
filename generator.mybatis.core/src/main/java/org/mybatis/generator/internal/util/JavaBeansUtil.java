...
public class JavaBeansUtil {
	...
	public static String getAddMethodName(String property) {
		StringBuilder sb = new StringBuilder();
	...
	public static Method getJavaBeansGetter(IntrospectedColumn introspectedColumn, String fieldName, String fieldType){
		FullyQualifiedJavaType type = new FullyQualifiedJavaType(fieldType);
		
		Method method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(type);
		method.setName(getGetterMethodName(fieldName, type));
	...
	public static Field getJavaBeanField(IntrospectedColumn introspectedColumn, String fieldName, String fieldType) {

		Field field = new Field();
		field.setVisibility(JavaVisibility.PRIVATE);
		field.setName(fieldName);
		field.setType(new FullyQualifiedJavaType(fieldType));
	...
	public static Method getJavaBeansSetter(IntrospectedColumn introspectedColumn, String fieldName, String fieldType) {
		FullyQualifiedJavaType type = new FullyQualifiedJavaType(fieldType);
	...
	public static Method getJavaBeansAdder(IntrospectedColumn introspectedColumn, String fieldName, String paramName){
		FullyQualifiedJavaType type = introspectedColumn.getFullyQualifiedJavaType();
		
		Method method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setName(getAddMethodName(fieldName));
		method.addParameter(new Parameter(type, paramName));
		...
		sb.append(type.getFullTypeSpecification());
		sb.append(">();");
		method.addBodyLine(sb.toString());
		sb.setLength(0);
		sb.append("}");
