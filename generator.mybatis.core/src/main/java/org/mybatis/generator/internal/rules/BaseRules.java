...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateUpdateByPrimaryKeyWithBLOBs() {
    	if(this.tableConfiguration.noBlobs()){
    		return false;
    	}
    ...
    public boolean generateBatchInsert(){
    	...
    	boolean rc = this.tableConfiguration.isEnableBatchInsert();
    	
    	return rc;
    }
    
    public boolean generateBatchDelete(){
    	if (isModelOnly) {
            return false;
        }
    	
    	boolean rc = this.tableConfiguration.isEnableBatchDelete();
    ...
    public boolean generateBatchUpdate(){
    	...
    	boolean rc = this.tableConfiguration.isEnableBatchUpdate();
    	
    	return rc;
    }
    
    public boolean generateCondition(){
    	return this.tableConfiguration.isEnableSelectByCondition();
    }
}
