...
public class ResultMapWithoutBLOBsElementGenerator extends
    ...
    private void addResultMapElements(XmlElement answer) {
        ...
        if(this.introspectedTable.getTableConfiguration().noBlobs()){
        	this.addResultMapBlobsElements(answer);
        }
    }
    ...
    private void addResultMapConstructorElements(XmlElement answer) {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            if(introspectedColumn.isSecurity()){
            	resultElement.addAttribute(new Attribute(
                        "jdbcType", introspectedColumn.getSecurityJdbcType())); //$NON-NLS-1$
            }else{
            	resultElement.addAttribute(new Attribute(
    ...
    private void addResultMapBlobsElements(XmlElement answer) {
        for (IntrospectedColumn introspectedColumn : introspectedTable
                .getBLOBColumns()) {
            XmlElement resultElement = new XmlElement("result"); //$NON-NLS-1$
