...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.BatchDeleteElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.BatchInsertElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.BatchUpdateByConditionElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ConditionUpdateElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ItemUpdateSelectElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectIdByConditionElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.WhereConditionElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addUpdateItem(answer);
        addUpdateCondition(answer);
        ...
        addBatchUpdateByConditionElement(answer);
        addSelectIdByConditionElement(answer);
    ...
    protected void addWhereCondition(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractXmlElementGenerator elementGenerator = new WhereConditionElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    ...
    protected void addBatchInsertElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateBatchInsert()){
    ...
    protected void addBatchUpdateElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateBatchUpdate()){
    ...
    protected void addBatchDeleteElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateBatchDelete()){
    		AbstractXmlElementGenerator elementGenerator = new BatchDeleteElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    ...
    protected void addUpdateByConditionElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    ...
    protected void addBatchUpdateByConditionElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractXmlElementGenerator elementGenerator = new BatchUpdateByConditionElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    
    protected void addUpdateItem(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractXmlElementGenerator elementGenerator = new ItemUpdateSelectElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    
    protected void addUpdateCondition(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractXmlElementGenerator elementGenerator = new ConditionUpdateElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    
    protected void addSelectIdByConditionElement(XmlElement parentElement){
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractXmlElementGenerator elementGenerator = new SelectIdByConditionElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    ...
    public String getFileName() {
        return this.introspectedTable.getMyBatis3XmlMapperFileName();
    }
}
