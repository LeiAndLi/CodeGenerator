...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.BatchDeleteMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.BatchInsertMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.BatchUpdateByConditionMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.BatchUpdateMethodGenerator;
...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByCondtionMethodGenerator;
...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectIdByConditionMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addBatchUpdateByConditionMethod(interfaze);
        this.addSelectIdByConditionMethod(interfaze);
    ...
    protected void addBatchUpdateMethod(Interface interfaze){
    ...
    protected void addBatchDeleteMthod(Interface interfaze){
    	if(this.introspectedTable.getRules().generateBatchDelete()){
    		AbstractJavaMapperMethodGenerator methodGenerator = new BatchDeleteMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
    ...
    protected void addSelectByConditionMethod(Interface interfaze) {
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractJavaMapperMethodGenerator methodGenerator = new SelectByCondtionMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
    ...
    protected void addBatchUpdateByConditionMethod(Interface interfaze){
    	...
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractJavaMapperMethodGenerator methodGenerator = new BatchUpdateByConditionMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
    
    protected void addSelectIdByConditionMethod(Interface interfaze){
    	
    	if(this.introspectedTable.getRules().generateCondition()){
    		AbstractJavaMapperMethodGenerator methodGenerator = new SelectIdByConditionMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
