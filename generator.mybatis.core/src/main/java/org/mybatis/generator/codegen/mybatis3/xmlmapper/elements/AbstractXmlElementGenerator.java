...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
    ...
    protected XmlElement getForeachElement(String separator, String target, boolean hasOpenClose){
    	XmlElement answer = new XmlElement("foreach");
    	
    	answer.addAttribute(new Attribute("collection", target));
    	answer.addAttribute(new Attribute("index", "index"));
    	answer.addAttribute(new Attribute("item", "item"));
    	answer.addAttribute(new Attribute("separator", separator));
    	if(hasOpenClose){
    		answer.addAttribute(new Attribute("open", "("));
	...
	protected XmlElement buildIfElement(String fieldName, String prefix){
		...
		xml.addAttribute(new Attribute("test", sb.toString()));
		
		return xml;
	}
	
	protected XmlElement buildIfListElement(String fieldName, String prefix){
		XmlElement xml = new XmlElement("if");
