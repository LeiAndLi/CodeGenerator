...
public class SelectShortByConditionMethodGenerator extends AbstractJavaMapperMethodGenerator{
	...
	public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getSelectShortByConditionStatementId());
