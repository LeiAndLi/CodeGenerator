...
public class TableConfiguration extends PropertyHolder {
    ...
    private Map<String, SecurityColumn> securityColumns;
    
    private PlanTable planTable;
    
    private boolean isPlan;
    
    private TableConfiguration ptc;
    ...
    public TableConfiguration(Context context) {
        ...
        this.securityColumns = new HashMap<String, SecurityColumn>();
    ...
    public XmlElement toXmlElement() {
        ...
        if(this.planTable != null){
            xmlElement.addElement(this.planTable.toXmlElement());
        }
	...
	public boolean isEnableBatchInsert() {
		return enableBatchInsert;
	}
	...
	public boolean isEnableBatchDelete() {
		return enableBatchDelete;
	}

	public void setEnableBatchDelete(boolean enableBatchDelete) {
		this.enableBatchDelete = enableBatchDelete;
	}
	...
	public boolean noBlobs(){
		String str = this.getProperty(PropertyRegistry.NO_BLOBS);
		boolean rc = StringUtility.isTrue(str);
		return rc;
	}

	public boolean isEnableSelectByCondition() {
		return enableSelectByCondition;
	}

	public void setEnableSelectByCondition(boolean enableSelectByCondition) {
		this.enableSelectByCondition = enableSelectByCondition;
	}

	public boolean hasSecurityColumn(){
		return this.securityColumns.size() > 0;
	}
	
	public Map<String, SecurityColumn> getSecurityColumns() {
		return securityColumns;
	}

	public void setSecurityColumns(Map<String, SecurityColumn> securityColumns) {
		this.securityColumns = securityColumns;
	}
	
	public void addSecurityColumns(SecurityColumn securityColumns ){
		this.securityColumns.put(securityColumns.getColumnName(), securityColumns);
	}
	
	
	
	public SecurityColumn getSecurityColumn(String columnName){
		if(this.securityColumns.containsKey(columnName)){
			return this.securityColumns.get(columnName);
		}
    ...
    public TableConfiguration getPtc() {
        return ptc;
    }

    public void setPtc(TableConfiguration ptc) {
        this.ptc = ptc;
    }
    ...
    public void setEnableExt(boolean enableExt) {
